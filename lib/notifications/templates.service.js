...
export function getReviewPayload(order, item) {
  ...
  // CTA dynamic part — only the path suffix after the base URL in the template
  // Template base URL is like: https://www.ravenfragrance.in/product/
  // Dynamic part: product-slug?review=true#reviews-section
  const ctaSuffix = `${productSlug}?review=true#reviews-section`;
  ...
  return {
    ...
    ctaVariables: [ctaSuffix], // CTA 1 = dynamic review URL suffix
  };
}
