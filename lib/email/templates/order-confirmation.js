export default function orderConfirmationTemplate(data) {
  ...
  <body class="email-body" style="background-color: #f8f6f1; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; padding: 0; margin: 0;">
    <!--[if mso]><table role="presentation" align="center" width="640" cellpadding="0" cellspacing="0" border="0"><tr><td><![endif]-->
    <div class="email-container" style="max-width: 640px; margin: 0 auto; background-color: #ffffff;">
